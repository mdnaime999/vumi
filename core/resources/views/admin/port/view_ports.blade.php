                ...
                <div class="row">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <li class="breadcrumb-item active">বন্দর</li>
                        </ol>
                    </div><!-- /.col -->
                </div><!-- /.row -->
            </div><!-- /.container-fluid -->
                        ...
                        <div class="card mt-3">
                            <div class="card-header">
                                <div class="fa-pull-left">
                                    <h3 class="card-title">
                                        <i class="fas fa-list"></i> বন্দর তথ্য
                                    </h3>
                                </div>
                                <div class="fa-pull-right @if(array_search("admin/add_port", $access) > -1 || $checkAdmin) @else d-none @endif">
                                    <a class="" href="{{ route('add_port') }}">
                                        <button class="btn btn-sm btn-info"><i class="fa fa-plus"></i> বন্দর যোগ করুন</button>
                                    </a>
                                </div>
                            </div>
                            <!-- /.card-header -->
