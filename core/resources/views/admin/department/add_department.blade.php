    ...
    <div class="content-wrapper" style="font-family: Roboto">
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-12">
                        <h5 class="m-0 text-dark">বিভাগ</h5>
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <div class="col-12">
                        <div class="card card-info">
                            <div class="card-header">
                                <h3 class="card-title mb-0">বিভাগ যোগ করুন</h3>
                            ...
                            <form method="POST" action="{{ route('save.department') }}" enctype="multipart/form-data" role="form">
                                @csrf
