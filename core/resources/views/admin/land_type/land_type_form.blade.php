    ...
    <div class="row">
        <div class="col-md-7">
            <div class="form-group">
                ...
                <input id="name" type="text" class="form-control{{ $errors->has('name') ? ' is-invalid' : '' }}" name="name" value="{{ old('name', optional($type)->name) }}" autofocus>
        ...
        <div class="col-md-4">
            ...
            <div class="form-group">
                ...
                <select id="status" class="form-control{{ $errors->has('status') ? ' is-invalid' : '' }}" name="status" autofocus>
                    ...
                    <option value="1" @if (optional($type)->status == "1")
                        selected
                        @endif selected>সক্রিয়</option>
                    <option value="0" @if (optional($type)->status == "0")
                        selected
