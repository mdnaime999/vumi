                ...
                <div class="row">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <li class="breadcrumb-item active">পদবী</li>
                        </ol>
                    </div>
                </div>
            </div>
                        ...
                        <div class="card mt-3">
                            <div class="card-header">
                                <div class="fa-pull-left">
                                    <h3 class="card-title">
                                        <i class="fas fa-list"></i> পদবী তথ্য
                                    </h3>
                                </div>
                                <div class="fa-pull-right @if(array_search("admin/add/designation", $access) > -1 || $checkAdmin) @else d-none @endif">
                                    <a href="{{ route('add.designation') }}">
                                        <button class="btn btn-sm btn-info"><i class="fa fa-plus"></i> পদবী যোগ করুন</button>
                                    </a>
                                </div>
                            </div>
                            <div class="card-body">
