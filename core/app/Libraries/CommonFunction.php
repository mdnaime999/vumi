...
class CommonFunction
{
    ...
    public static function getSliderImageFromURL($db_path, $local_path=null, $id=null, $width='357px', $height ='325px')
    {
        $file_path = (string)($local_path.$db_path);
        if (is_file($file_path)) {
            return '<img class="img-thumbnail" src="'. asset($file_path) .'" alt="Something" style="width: '.$width.'; height: '.$height.';" id="'.$id.'" />';
    ...
    public static function getSpecialDayImageFromURL($db_path, $local_path=null, $id=null, $width='494px', $height ='325px')
    {
        $file_path = (string)($local_path.$db_path);
        if (is_file($file_path)) {
            return '<img class="img-thumbnail" src="'. asset($file_path) .'" alt="Something" style="width: '.$width.'; height: '.$height.';" id="'.$id.'" />';
    ...
    public static function getproductImageFromURL($db_path, $local_path=null, $id=null, $width='320px', $height ='180px')
    {
        $file_path = (string)($local_path.$db_path);
        if (is_file($file_path)) {
            return '<img class="img-thumbnail" src="'. asset($file_path) .'" alt="Something" style="width: '.$width.'; height: '.$height.';" id="'.$id.'" />';
    ...
    public static function SendMail($receiver,$name,$message,$subject)
    {
        ...
        $mail->Host       = 'mail.timerni.com';                     //Set the SMTP server to send through
        $mail->SMTPAuth   = true;                                   //Enable SMTP authentication
        $mail->Username   = 'services@mail.timetechri.co.uk';                     //SMTP username
        $mail->Password   = 'tikarboi2021';                               //SMTP password
        $mail->SMTPSecure = PHPMailer::ENCRYPTION_STARTTLS;         //Enable TLS encryption; `PHPMailer::ENCRYPTION_SMTPS` encouraged
        $mail->Port       = 587;                                    //TCP port to connect to, use 465 for `PHPMailer::ENCRYPTION_SMTPS` above

        //Recipients
        $mail->setFrom('services@mail.timetechri.co.uk', 'Time research & Innovation');
